...
public class Tic_Tac_Toe extends JFrame implements ActionListener {
	...
	JButton newP = new JButton("Click Here For a New Game"); //(New Version, simpler)
	...
	public Tic_Tac_Toe() {
		...
		b1.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b1.addActionListener(this);
		b2.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b2.addActionListener(this);
		b3.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b3.addActionListener(this);
		b4.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b4.addActionListener(this);
		b5.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b5.addActionListener(this);
		b6.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b6.addActionListener(this);
		b7.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b7.addActionListener(this);
		b8.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		b8.addActionListener(this);
		b9.setFont(new Font("Times New Roman", Font.PLAIN, 50));
		...
		newP.setFont(new Font("Times New Roman", Font.PLAIN, 12));

		//For future development (PVC)
		//newX.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		//newX.addActionListener(this);
		//newX.setToolTipText("New game against the computer as X");

		//newO.setFont(new Font("Times New Roman", Font.PLAIN, 12));
